...
<div class="audience-section">
  <div class="audience-card">
    ...
    <a href="/hotplex/guide/getting-started.html" class="audience-btn">Start Journey</a>
  </div>
  
  <div class="audience-card">
    <h3>Developers</h3>
    <p>Build custom agent behaviors with our Go, Python, and TS SDKs.</p>
    <a href="/hotplex/guide/architecture.html" class="audience-btn">View Architecture</a>
  </div>
