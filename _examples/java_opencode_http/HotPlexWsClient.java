 ...
 * - Metrics collection
 *
 * Compile: javac -d . HotPlexWsClient.java
 * Run: java com.hotplex.example.HotPlexWsClient
 */
public class HotPlexWsClient {
    ...
    public String getVersion() throws Exception {
        ...
        ws.sendText("{\"type\":\"version\"}").get(5, TimeUnit.SECONDS);
        // Note: Version response handling would go here
